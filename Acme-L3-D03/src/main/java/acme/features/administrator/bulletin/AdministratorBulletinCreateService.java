...
public class AdministratorBulletinCreateService extends AbstractService<Administrator, Bulletin> {
	...
	@Autowired
	protected AdministratorBulletinRepository r;
	...
	public void bind(final Bulletin object) {
		assert object != null;
		super.bind(object, "moment", "title", "message", "critical", "moreInfo");
	}
	...
	public void unbind(final Bulletin object) {
		assert object != null;
		Tuple tuple;
		tuple = super.unbind(object, "moment", "title", "message", "critical", "moreInfo");
