...
@Service
public class AuthenticatedAssitantCreateService extends AbstractService<Authenticated, Assistant> {
	...
	public void unbind(final Assistant object) {
		...
		tuple = super.unbind(object, "supervisor", "expertiseFields", "resume", "moreInfo");
