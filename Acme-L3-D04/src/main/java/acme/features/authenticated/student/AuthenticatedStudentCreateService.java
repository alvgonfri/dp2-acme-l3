...
public class AuthenticatedStudentCreateService extends AbstractService<Authenticated, Student> {
	...
	public void authorise() {
		...
		status = !this.getRequest().getPrincipal().hasRole(Student.class);
	...
	public void bind(final Student object) {
		...
		super.bind(object, "statement", "strongFeatures", "weakFeatures", "moreInfo");
	}
	...
	public void unbind(final Student object) {
		...
		tuple = super.unbind(object, "statement", "strongFeatures", "weakFeatures", "moreInfo");
